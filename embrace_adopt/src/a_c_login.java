 ...
 */
@WebServlet("/a_c_login")
public class a_c_login extends HttpServlet {
	...
	try{
		System.out.println("connected successfully here ");
			...
			System.out.println("connected successfully here before select ");
			try {
				if (con != null && !con.isClosed()) {
					ResultSet rs = null,rs1=null;
					String sql = "select * from adoption_heads where username= '"+name+"' and password= '"+pass+"'";
