...
<!-- //web-fonts -->
 ...
 <br>
 <br>
 	<form  action="a_c_login" method="post" class="form-signin" width="100" height="100">
		<p>
	...
	<form  action="a_c_register.jsp" method="post" class="form-signin" width="100" height="100">
		<p>
			<font color="red">${error}</font>
		</p>
			<button class="btn btn-lg btn-primary btn-block" type="submit" style= width:30%>Not yet registered?</button> <br>
