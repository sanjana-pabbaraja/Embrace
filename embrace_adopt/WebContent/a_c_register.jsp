...
$('submit').click(function () {
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
 	...
 	<form action="a_c_register" method="post" class="form-signin">
		<p>
			...
			<input type="text" class="form-control" name="id" placeholder="centre id" required="">  	      
      <button id="submit" class="btn btn-lg btn-primary btn-block" type="submit" style= width:20%>Register</button> <br>
		
	</form>
	
	<form action="a_c_login" method="post" class="form-signin">
	<button id="submit" class="btn btn-lg btn-primary btn-block" type="submit" style= width:20%>Already registered?</button> <br>	    	
	</form>
