...
<%int uid; %>
 <%uid=(Integer)request.getAttribute("userid"); %>
	...
	<!-- //menu-js -->
	 <h3 class="agileits-title">Adoption Centres</h3>
<%
		...
		<div class="container">
			...
			<div class="col-md-6 w3lsbreeds-grid">
				...
				<div class="breeds-right">
					...
					<p style="font-size:18px "><b>LOCATION:</b><%=rs.getString("location")%></h3>
					<p style="font-size:18px "><b>E-MAIL:</b><%=rs.getString("email")%></p>
					<p style="font-size:18px "><b>CONTACT:</b><%=rs.getString("phone_no")%></p>
					<p><%=rs.getString("info")%>
					</p>
					<%int cid=Integer.parseInt(rs.getString("cid")); %>
					<form action="adoption.jsp" method="post">
					<input type="hidden" name="uid" value="<%=uid %>">
					<input type="hidden" name="cid" value="<%=cid %>">
					<button type="submit" class="w3more" ><i class="fa fa-mail-forward" aria-hidden="true"></i> More</button>
			</form>
				</div>
				<div class="clearfix"></div>
			</div></div></div>
...
<!-- //testimonials -->	
		...
		<div class="banner-text1"> 
			<div class="container">
				...
				<button type="button" class="btn btn-lg btn-primary btn-block" style="display: flex;align-items: center;justify-content: center;">DONATE NOW</button>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h1 class="modal-title">EMBRACE</h1>
					</div>
