...
<body>
 ...
 <%uid=(Integer)request.getAttribute("userid"); %>
				...
				<div class="menu">
					...
					<div class="toggle">
						...
						<li><a href="index.html" class="active">Home</a></li>
								...
								<li><a href="addchildren.jsp">Add Children</a></li>
   ...
   <div class="breeds w3ls-section">
    <h3 class="agileits-title">Add Children</h3>
		<div class="container">
			  
			<div class="col-md-6 w3lsbreeds-grid">
				
				<div class="breeds-right">
				 <form action="addchildren.jsp" method="post">
				 <input type="hidden" name="uid" value="<%=uid %>">

 
				 <button type="submit">Add</button>
					<!-- <a class="w3more" href="addchildren.jsp" "><i class="fa fa-mail-forward" aria-hidden="true"></i> Add</a>
				 --></form></div>
				<div class="clearfix"></div>
			</div></div></div>
			 <div class="breeds w3ls-section">
    <h3 class="agileits-title">View Children</h3>
		<div class="container">
...
<form action="view.jsp" method="post">
				 <input type="hidden" name="uid" value="<%=uid %>">
				 <button type="submit">Add</button>
					<!-- <a class="w3more" href="view.jsp" "><i class="fa fa-mail-forward" aria-hidden="true"></i> View</a>
				 --></form>				</div>
				<div class="clearfix"></div>
			</div></div></div>
