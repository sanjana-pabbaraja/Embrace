...
<!-- //web-fonts -->
		...
		<div class="header">
			<div class="container">
				...
				<div class="logo">
					<h3><a href="admin.jsp">EMBRACE</a></h3>
				</div> 
...
$('submit').click(function () {
 ...
 <H1>ADOPTION CENTRES </H1>
 
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
 

 
 	<form action="addadoption" method="post" class="form-signin">
		<p>
			...
			<textarea class="form-control" name="info" placeholder="about the adoption center" required="">"about the adoption center"</textarea>
			<br>
